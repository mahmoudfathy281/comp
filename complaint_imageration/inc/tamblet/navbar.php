...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainnav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="dashpord.php"><?php echo lang('dashpord_admin')?></a>
                    <hr class="hr hr1">
                </li>
                <li class="nav-item">
                    <a id="display" class="nav-link" href="complaint.php"><?php echo lang('complaint_admin')?></a>
                    <hr class="hr hr2">
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="personal.php"><?php echo lang('Member_admin')?></a>
                    <hr class="hr hr3">
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="saveing.php"><?php echo lang('save_admin')?></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="cpanal/index.php?user_id=<?php echo $user_id?>">اللوحة</a>
                </li>
            </ul>
        </div>
